...
class ServiceTest {
		...
		@Test
		 void addSignUpTestFirstName() {
		UserDTO u1 = userDetails();
	    String s1 = "FirstName is not valid";
		try { service.addSignUpDetails(u1);}
		catch(SignUpExceptions e){ assertEquals(s1,(e.getMessage()));}
	   }
		
        @Test
		 void addSignUpTestFirstNameBlank()
		{ UserDTO u1 = userDetails(); 
		  u1.setFirstName("");
		  String s1 = "FirstName is not valid";
		  try { service.addSignUpDetails(u1);}
		...
		@Test
		 void addSignUpTestLastNameBlank(){
			UserDTO u1 = userDetails();
			u1.setFirstName("sai");
			u1.setLastName("");
			String s1 = "LastName is not valid ";
		...
		@Test
		 void addSignUpTestEmailIdBlank(){
			UserDTO u1 = userDetails();
